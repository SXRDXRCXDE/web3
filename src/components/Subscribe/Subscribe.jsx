...
export default function Subscribe() {
    ...
    return<>
        <div className={'w-full h-auto min-[1000px]:min-h-[65vh] max-[450px]:min-h-[350px] max-[1000px]:min-h-[400px]  flex flex-col items-center justify-start gap-4 mt-10 '}>
            ...
            <div className={'max-[1000px]:w-full w-[85%] flex flex-col justify-start max-[1000px]:items-center items-start relative max-[1000px]:mt-6'}>

                <img className={'w-full h-[360px] object-fill max-[1000px]:w-fit max-[1000px]:hidden absolute top-0 left-0 '} src={footer_layer} alt={'web3'}/>
                ...
                <img className={'max-[450px]:w-20 max-[450px]:right-32 w-60 max-[1000px]:w-40  absolute -bottom-[161px] max-[450px]:-bottom-[140px] max-[1000px]:right-72 max-[1000px]:-bottom-60  max-[1100px]:right-[110px] right-[266px] z-20'} src={rabbit_footer} alt={'web3'}/>
                ...
                <div className={'max-[450px]:gap-2 max-[1000px]:gap-12 max-[1000px]:flex-row-reverse flex justify-center items-center z-10 absolute max-[450px]:right-2 max-[450px]:top-52  max-[1000px]:right-10 max-[1000px]:top-64 max-[1100px]:right-52 max-[1100px]:top-60 top-56 right-[450px]'}>
