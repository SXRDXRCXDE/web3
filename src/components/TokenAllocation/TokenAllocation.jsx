    ...
    return<>
        <div className={'w-full h-[937px] max-[500px]:h-[730px] relative flex max-[1000px]:flex-col max-[1000px]:justify-start items-center justify-center max-[1000px]:gap-4 max-[1150px]:gap-12 gap-24 overflow-hidden'}>
            ...
            <div className={'w-auto max-[1350px]:h-[400px] h-[500px] z-10 flex flex-col items-start justify-between relative duration-300 max-[1000px]:hidden'}>
                ...
                <p className={'text-[20px] text-white translate-x-[83px]'}>Advisors <span className={'text-[25px] text-[#F80AFB]'}>6%</span> </p>
                <p className={'text-[20px] text-white translate-x-[41px]'}>Growth Fund <span className={'text-[25px] text-[#F80AFB]'}>6%</span> </p>
                <p className={'text-[20px] text-white'}>Development <span className={'text-[25px] text-[#F80AFB]'}>7%</span> </p>
                <p className={'text-[20px] text-white translate-x-[41px]'}>Marketing <span className={'text-[25px] text-[#F80AFB]'}>9%</span> </p>
                <p className={'text-[20px] text-white translate-x-[83px]'}>Team <span className={'text-[25px] text-[#F80AFB]'}>13%</span> </p>
            ...
            <div className={'w-auto max-[1350px]:h-[400px] h-[500px] flex flex-col items-end justify-between z-10 duration-300 max-[1000px]:hidden'}>
                ...
                <p className={'text-[20px] text-white -translate-x-[83px]'}> <span className={'text-[25px] text-[#F80AFB]'}>20%</span> Rewards </p>
                <p className={'text-[20px] text-white -translate-x-[41px]'}> <span className={'text-[25px] text-[#F80AFB]'}>23%</span> Presale </p>
                <p className={'text-[20px] text-white'}> <span className={'text-[25px] text-[#F80AFB]'}>3%</span> Public Sale </p>
                <p className={'text-[20px] text-white -translate-x-[41px]'}> <span className={'text-[25px] text-[#F80AFB]'}>7%</span> Liquidity </p>
                <p className={'text-[20px] text-white -translate-x-[95px]'}> <span className={'text-[25px] text-[#F80AFB]'}>6%</span> Seed </p>
            ...
            <div className={'min-[1000px]:hidden flex justify-between items-start px-5 z-10 w-full '}>
                ...
                <div className={'flex flex-col items-start leading-[20px] text-start'}>
                    ...
                    <p className={'text-[15px] text-white'}> Public Sale <br/> <span className={'text-[20px] text-[#F80AFB]'}>3% </span> </p>
                    <p className={'text-[15px] text-white '}> Advisors <br/> <span className={'text-[20px] text-[#F80AFB]'}>6% </span></p>
                    <p className={'text-[15px] text-white '}> Rewards <br/> <span className={'text-[20px] text-[#F80AFB]'}>20% </span> </p>

                </div>

                <div className={'flex flex-col items-start leading-[20px] text-start'}>

                    <p className={'text-[15px] text-white'}> Marketing <br/> <span className={'text-[20px] text-[#F80AFB]'}>9% </span> </p>
                    <p className={'text-[15px] text-white '}> Team <br/> <span className={'text-[20px] text-[#F80AFB]'}>13% </span></p>
                    <p className={'text-[15px] text-white '}> Growth Fund  <br/> <span className={'text-[20px] text-[#F80AFB]'}>6%</span> </p>
